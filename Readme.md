# Yet another Dependency Injection Library for JavaScript Apps
...
- `1` [Registration](#1-registration)
    - `1.1` [Type](#11-register-type)
    - `1.2` [Instance](#12-register-instance)
    - `1.3` [Factory](#12-register-factory)
...
When registering the component, we specify identifiers, by which the dependency is resolved. It can be some another `Type`, string identifier, `self-type`. 

> But we do not encourage you to use the string identifiers.
...
// or as initializer function wich will be called on first `IFoo` require.
...
_Define identifiers when registering a Component_
...
> TypeScript support: initially this project targets plain JavaScript, but TypeScript support will be also implemented.

---

### `2.2` Properties

Property Injections are supported by `Type`_s_ entries.
